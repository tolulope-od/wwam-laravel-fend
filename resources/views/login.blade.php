...
<div id="wrapper">
  ...
  <div class="alert alert-error rounded-corners" style="top: 20px; left: 477px; display: none;">
    <i class="close-dialog fa fa-times-circle-o close"></i>
    <h4>Error</h4>
    <p>
      The profile does not exist. Please signup again.        </p>
  </div>
  <div id="content">
    <div id="center-form-container" class="login">
      <h2>Login</h2>
      <div>
        <form action="/users/login" class="clearfix" accept-charset="utf-8" method="post">            <p>
            <label for="username">Username:</label>
            <input name="username" value="" type="text" id="form_username">                <span class="error"></span>
          </p><p>
            <label for="password">Password:</label>
            <input name="password" value="" type="password" id="form_password">                <span class="error"></span>
          </p>
  ...
  <div id="book-me-confirmation-dialog" class="dialog confirmation-dialog">
    <div class="dialog-header">
      <img src="/assets/img/pages/home2/mini.png?1570011323" alt="">
  ...
  <div id="notification-container" class="alert alert-success rounded-corners" style="top: 20px; left: 477px; display: none;">
    <i class="close-dialog fa fa-times-circle-o close"></i>
    <h4></h4>
    <p></p>
  </div>
  ...
  <div id="chat-request-sent-dialog" class="dialog confirmation-dialog">
    ...
    <div class="dialog-content">
      <img src="" class="dialog-logo">
      <div class="right-content">
        <img src="/assets/img/chat_03.png?1570010605" alt="">
