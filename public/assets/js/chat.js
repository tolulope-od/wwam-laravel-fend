...
var socket = io.connect('http://166.70.53.49:4600/');
...
$(document).ready(function() {
    ...
    socket.on('user_login', function(username){
        ...
        //     var response = data;
        // }, 'json');
        console.log("the user who just logged in is ");
...
$.fn.closeChatRoom = function() {
    $(this).click(function(e) {
        ...
        if(index != -1) {
           ...
           console.log("existing_ones are ");
           console.log(existingOnes);
